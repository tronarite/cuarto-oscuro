...
INSERT INTO "new_Photo" ("aperture", "cameraMake", "cameraModel", "contentHash", "createdAt", "description", "displayPath", "focalLength", "galleryId", "height", "id", "iso", "latitude", "lens", "longitude", "order", "originalPath", "shutterSpeed", "takenAt", "thumbPath", "updatedAt", "width") SELECT "aperture", "cameraMake", "cameraModel", "contentHash", "createdAt", "description", "displayPath", "focalLength", "galleryId", "height", "id", "iso", "latitude", "lens", "longitude", "order", "originalPath", "shutterSpeed", "takenAt", "thumbPath", "updatedAt", "width" FROM "Photo";
DROP TABLE "Photo";
