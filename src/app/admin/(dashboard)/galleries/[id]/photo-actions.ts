...
export async function uploadPhoto(
  ...
  // siempre). descriptionAutoGenerated marca que este valor lo puso la
  // IA, no el admin, para que "Identificar fotos ya subidas" pueda
  // regenerarlo más adelante sin arriesgar nunca un pie de foto manual.
  ...
  const photo = await prisma.photo.create({
    data: {
      ...
      descriptionAutoGenerated: autoCaption != null,
      originalPath: "",
      displayPath: "",
      thumbPath: "",
...
export async function updatePhotoDescription(
  ...
  // Se edita a mano desde el campo de texto del admin: deja de contar
  // como "generado automáticamente" (BETA), aunque se deje vacío — así
  // "Identificar fotos ya subidas" nunca vuelve a tocar esta foto salvo
  // que el propio admin borre el texto Y ADEMÁS relance la generación.
  const photo = await prisma.photo.update({
    where: { id: photoId },
    data: { description: description || null, descriptionAutoGenerated: false },
  });
