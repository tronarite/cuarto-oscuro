  ...
  return (
    <main className="relative">
      ...
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[clamp(1180px,92vw,3200px)] items-center justify-between px-6 py-4">
          <BackHomeLink siteTitle={settings.siteTitle} />
          <ThemeToggle />
        </div>
      </header>

      <div className="mx-auto max-w-[clamp(1180px,92vw,3200px)] px-6 pb-10 pt-16 sm:pb-14 sm:pt-20">
